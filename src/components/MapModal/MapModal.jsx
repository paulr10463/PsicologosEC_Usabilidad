...
export default function MapModal(){
  ...
  return (
    <>
      ...
      <dialog id="my_modal_1" className="flex-auto text-[0.7rem] bg-primary-4 px-4 py-4 rounded-2xl shadow-md leading-3">
        <div className="modal-box">
          <div className='flex justify-between'>
            ...
            <form method="dialog">
              <button className="btn btn-sm btn-circle btn-ghost absolute right-9 top-5" onClick={() => document.getElementById('my_modal_1').close()}>
