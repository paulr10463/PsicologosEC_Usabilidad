                    ...
                    <div className='bg-white w-full rounded-2xl'>
                        <div className='flex flex-col lg:flex-row p-3'>
                            <div tabIndex={0} className='text-[0.7rem] lg:w-[70%]  px-4 py-4 rounded-2xl shadow-md leading-3'>
                                {t('Atención online (Whatsapp, skype, zoom o cualquier otra) de niños, jóvenes, adultos. Parejas y Familias Problemas de Adicción a internet, Cáncer, Conductas Adictivas, Disfonías, Educación Hijos, Estrés...')}
                            </div>
